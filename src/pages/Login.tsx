    ...
    >
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-8 sm:px-6 lg:justify-end lg:px-[6.5vw] lg:py-10">
        <section
          ...
          className="w-full max-w-[28rem] rounded-[1.35rem] border border-white/70 bg-white/[0.96] p-6 shadow-[0_24px_80px_rgba(15,23,42,0.22)] backdrop-blur-xl sm:p-8"
        >
          ...
          <header className="mb-7">
            <h1 id="login-title" className="text-[2.05rem] font-semibold tracking-[-0.035em] text-[#0d215d] sm:text-[2.25rem]">
              Bem-vindo
            </h1>
          ...
          <Form {...loginForm}>
            <form onSubmit={loginForm.handleSubmit(onSignIn)} className="space-y-5" noValidate>
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[0.9rem] font-semibold text-slate-700">E-mail institucional</FormLabel>
              ...
              <Button
                type="submit"
                className="h-12 w-full rounded-lg bg-[#0874dc] text-[0.92rem] font-semibold text-white shadow-[0_8px_22px_rgba(8,116,220,0.28)] transition hover:bg-[#0768c6] focus-visible:ring-[#0d75d8] dark:bg-[#0874dc] dark:text-white dark:hover:bg-[#0768c6]"
                disabled={isPending}
              >
                {isPending ? (
                  <>
